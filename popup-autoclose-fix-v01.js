(() => {
  const VERSION = 'popup-autoclose-fix-v02-artifact';
  let lastPopup = null;
  let lock = false;
  ...
  function injectPopupArtifactCss() {
    ...
    style.textContent = `
      .leaflet-popup { margin-bottom: 22px !important; }
  ...
  window.NYCIF_POPUP_AUTOCLOSE_FIX = { version: VERSION, active: true, artifactCss: true };
})();
