const CACHE_NAME = 'nycif-v07-date-normalizer';
const APP_SHELL = ['./','./index.html','./style.css','./fielddesk-v02.css','./weekstrip-v06-safe.css','./weekstrip-v06-fix.js','./date-normalizer-v07-safe.js','./app-v06-safe.js','./stats-v05-safe.js','./manifest.json','./icons/icon-192.svg','./icons/icon-512.svg'];
